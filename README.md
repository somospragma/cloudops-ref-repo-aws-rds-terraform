...
| <a name="enable_http_endpoint"></a> [enable_http_endpoint](#input\_enable_http_endpoint_) | Indica si se habilita el Data API para Aurora Serverless. Default is false. | `bool` | n/a | yes |
...
variable "rds_config" {
  type = list(object({
    ...
    cluster_config = list(object({                           
      ...
      enable_http_endpoint            = bool                 # Habilitar el Data API para Aurora Serverless
